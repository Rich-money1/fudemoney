...
const FUND_SOURCES = {
  ...
  twtech:     { code: 'ACDD04', template: 'yp010000' }, // 安聯台灣科技（累積型，不配息，僅走勢追蹤）
  twdam:      { code: 'ACDD01', template: 'yp010000' }, // 安聯台灣大壩（累積型，不配息，僅走勢追蹤）
  unisurge:   { code: 'ACPS10', template: 'yp010000' }, // 統一奔騰（累積型，不配息，僅走勢追蹤）
};
