...
const SECTION_ICONS = [
  { symbol: '◆', color: ACCENT },     // 核心觀點
  { symbol: '!', color: '#c0392b' },  // 市場疑慮/恐慌點
  { symbol: '✚', color: GREEN },      // 基本面體檢
  { symbol: '?', color: ORANGE },     // 原因拆解
  { symbol: '=', color: '#1565a0' },  // 框架/公式
  { symbol: '★', color: '#5e4b9e' },  // 本週焦點
  { symbol: '✓', color: GREEN },      // 操作建議
];
